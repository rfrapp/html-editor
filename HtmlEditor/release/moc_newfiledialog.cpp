...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_NewFileDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 74, 5)
    },
    "NewFileDialog\0on_buttonBox_accepted\0"
    "\0on_templateNames_currentIndexChanged\0"
    "index\0"
};
...
void NewFileDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_templateNames_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject NewFileDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_NewFileDialog.data,
      qt_meta_data_NewFileDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NewFileDialog.stringdata))
